...
import Evaluation.ResultItem;
 ...
 class InitializerWithThreading {
	...
	public InitializerWithThreading(){};
	...
	public static void main (String args[]) throws Exception{
		...
		for (int i=0; i<allHtmlParsingElements.length;i++){
			...
			InitializerWithThreading run =new InitializerWithThreading();
	...
	private void runMultipleInitializer() throws JSONException, IOException, InterruptedException{
		...
		for(ModelConfiguration modelConfig:allmodels){
			...
			FeatureTaggingThreading featTagger = new FeatureTaggingThreading(tokenizedInput, modelConfig, htmlFolder, htmlParsingElements, dictionary, preprocessing );
